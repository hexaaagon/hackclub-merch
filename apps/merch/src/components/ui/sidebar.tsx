  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed top-(--navbar-height,0px) bottom-0 z-10 hidden h-auto w-(--sidebar-width) mix-blend-difference invert transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      variant="ghost"
      className={cn(
        "justify-start px-0 font-normal text-xs group-data-[collapsible=icon]:p-2",
        className,
      )}
      onClick={(event) => {
        onClick?.(event);
    ...
    >
      ...
      <PanelLeftClose className="block group-data-[collapsible=icon]:hidden" />
