  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] before:content-[""] before:[background:radial-gradient(ellipse_at_50%_55%,transparent_10%,var(--footer)_0%)] before:[transform:translate3d(-50%,-50%,0)]',
    ...
    >
      ...
      <motion.div
        className={cn(
          "absolute top-[-71.5%] left-1/2 z-[3] h-[140%] w-[30%] rounded-b-full opacity-75 mix-blend-plus-lighter blur-3xl [background-position:0%_100%] [background-size:100%_200%] [transform:translate3d(-50%,0,0)]",
      ...
      />
      <div className="absolute top-0 left-0 z-[7] size-full opacity-50 mix-blend-overlay [background:repeating-linear-gradient(transparent,transparent_1px,white_1px,white_2px)]" />
    </div>
  );
}
